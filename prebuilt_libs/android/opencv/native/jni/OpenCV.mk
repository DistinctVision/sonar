...
OPENCV_MODULES:=aruco ccalib highgui video calib3d features2d flann videoio imgcodecs imgproc core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=aruco ccalib highgui video calib3d features2d flann videoio imgcodecs imgproc core
    OPENCV_LIB_TYPE:=SHARED
else
