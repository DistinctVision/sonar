...
Пробуем!
/// Видео
Здесь подкрашиваю красным оригинальный найденный маркер. Как можем заметить, результат получается не очень корректным - бла бла.
А так получилось, потому что для моделирования пространственных искажений маркера мы использовали аффинную матрицу. Важное свойство аффинной матрицы - линии, полученные после преобразования, остаются параллельными. В реальности, смотря на параллельные линии, мы можем увидеть такую картину:
