...
* При $R = I$, где $I$ - единичная матрица, поворота никакого не произойдет, так в таком случае локальные оси совпадают с мировыми. Т.е. $I$ - можно сказать задает нулевой поворот.
