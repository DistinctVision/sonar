...
* При $R = I$, где $I$ - единичная матрица, - это матрица соответствующему нулевому повороту (угол $\alpha = 0$), и в таком случае локальные оси совпадают с мировыми.
...
Теперь мы умеем масштабировать объект по осям, поворачивать его и перемещать. Объединим все одной формулой: $\vec{v'_i} = R \cdot S \cdot \vec{v_i} + \vec t$:
