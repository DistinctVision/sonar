...
if (OPENCV_ENABLE)
  if (LINUX OR WIN32)
    ...
    if (DEBUG_TOOLS_ENABLED)
      target_link_libraries(sonar -L${OpenCV_LIBS} opencv_core opencv_imgproc opencv_flann opencv_calib3d opencv_aruco opencv_video opencv_videoio opencv_highgui opencv_imgcodecs)
    else()
      target_link_libraries(sonar -L${OpenCV_LIBS} opencv_core opencv_imgproc opencv_flann opencv_calib3d opencv_aruco)
    endif()
  endif()
